    ...
    <section class="sidebar">	
      ...
      <ul class="sidebar-menu" data-widget="tree">  
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('matakuliah.view') }}"><i class="ti-more"></i>Tampilkan Matakuliah</a></li>
            <li><a href="calendar.html"><i class="ti-more"></i>Tambah Matakuliah</a></li>
          </ul>
        </li> 
		  
        <li class="treeview">
          <a href="#">
            <i data-feather="mail"></i> <span>Tampilkan Mata Kuliah</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-right pull-right"></i>
            </span>
          </a>
